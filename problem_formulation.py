...
def get_model_for_problem_formulation(problem_formulation_id,Mode='Default'):
    ...
    if Mode == 'Switch_unc_lev':            
        dike_model.uncertainties = levers
        dike_model.levers = uncertainties
